...
int main(int argc, char **argv){
    ...
    std::string train_uir_path = arg_parser.get_str("-train_ui_rating", "user-item-rating.graph", "input user-profile graph path");
    ...
    LookupMapper mapper(iur_sampler.back().vertex_size, dimension);
    ...
    {
        int num_gradient;
        long user, item, pos_i, pos_u, weight;
